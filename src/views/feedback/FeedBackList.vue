    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="意见反馈类型">
              <a-input placeholder="请输入意见反馈类型" v-model="queryParam.feedbackType"></a-input>
            </a-form-item>
          </a-col>
<!--          <a-col :md="6" :sm="8">
        ...
        <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="1:APP2:PC">
              <a-input placeholder="请输入1:APP2:PC" v-model="queryParam.type"></a-input>
            </a-form-item>
          </a-col>
          </template>-->
          <a-col :md="6" :sm="8" >
