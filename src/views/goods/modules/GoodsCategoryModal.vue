    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否显示">
          <a-select v-decorator="[ 'isVisible', validatorRules.isVisible]" placeholder="请选择是否显示">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否首页展示">
          <a-select v-decorator="[ 'isHomePage', validatorRules.isHomePage]" placeholder="请选择是否首页展示">
            <a-select-option value="0">否</a-select-option>
            <a-select-option value="1">是</a-select-option>
          </a-select>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        isVisible:{rules: [{ required: true, message: '请选择是否显示!' }]},
        isHomePage:{rules: [{ required: true, message: '请选择是否首页显示!' }]},
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'type','categoryName','shortName','pid','level','isVisible','attrId','attrName','keywords','description','sort','categoryPic','isHomePage'))
		  //时间格式化
        });
