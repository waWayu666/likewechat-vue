    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="一级分类id">
          <a-input placeholder="请输入一级分类id" v-decorator="['categoryId1', validatorRules.categoryId1 ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="二级分类id">
          <a-input placeholder="请输入二级分类id" v-decorator="['categoryId2', validatorRules.categoryId2 ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="三级分类id">
          <a-input placeholder="请输入三级分类id" v-decorator="['categoryId3', validatorRules.categoryId3 ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="品牌id">
          <a-input placeholder="请输入品牌id" v-decorator="['brandId', validatorRules.brandId ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="店铺分类id 首尾用,隔开">
          <a-input placeholder="请输入店铺分类id 首尾用,隔开" v-decorator="['groupIdArray', validatorRules.groupIdArray ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="促销类型 0无促销，1团购，2限时折扣">
          <a-input placeholder="请输入促销类型 0无促销，1团购，2限时折扣" v-decorator="['promotionType', validatorRules.promotionType ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="积分兑换类型 0 非积分兑换 1 只能积分兑换 ">
          <a-input placeholder="请输入积分兑换类型 0 非积分兑换 1 只能积分兑换 " v-decorator="['pointExchangeType', validatorRules.pointExchangeType ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="商品点击数量">
          <a-input-number v-decorator="[ 'clicks', validatorRules.clicks ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="库存预警值">
          <a-input-number v-decorator="[ 'minStockAlarm', validatorRules.minStockAlarm ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="虚拟销售量">
          <a-input-number v-decorator="[ 'virtualSales', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="虚拟收藏量">
          <a-input-number v-decorator="[ 'virtualCollect', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="销售数量">
          <a-input-number v-decorator="[ 'sales', validatorRules.sales ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="收藏数量">
          <a-input-number v-decorator="[ 'collects', validatorRules.collects ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="好评星级">
          <a-input placeholder="请输入好评星级" v-decorator="['star', validatorRules.star ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="评价数">
          <a-input-number v-decorator="[ 'evaluates', validatorRules.evaluates ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="分享数">
          <a-input-number v-decorator="[ 'shares', validatorRules.shares ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="一级地区id">
          <a-input placeholder="请输入一级地区id" v-decorator="['provinceId', validatorRules.provinceId ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="二级地区id">
          <a-input placeholder="请输入二级地区id" v-decorator="['cityId', validatorRules.cityId ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="商品主图">
          <a-input-number v-decorator="[ 'picture', validatorRules.picture ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="商品关键词">
          <a-input placeholder="请输入商品关键词" v-decorator="['keywords', validatorRules.keywords ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="页面不显示库存">
          <a-input placeholder="请输入页面不显示库存" v-decorator="['isStockVisible', validatorRules.isStockVisible ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="是否热销商品">
          <a-input placeholder="请输入是否热销商品" v-decorator="['isHot', validatorRules.isHot ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="是否新品">
          <a-input placeholder="请输入是否新品" v-decorator="['isNew', validatorRules.isNew ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="isPreSale">
          <a-input-number v-decorator="[ 'isPreSale', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="是否开具增值税发票 1是，0否">
          <a-input placeholder="请输入是否开具增值税发票 1是，0否" v-decorator="['isBill', validatorRules.isBill ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="商品状态 0下架，1正常，10违规（禁售）">
          <a-input placeholder="请输入商品状态 0下架，1正常，10违规（禁售）" v-decorator="['state', validatorRules.state ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
